...
public class Rectangle implements Cloneable {
	...
	public Rectangle getUnionRectangle(Rectangle rectangle) {
		...
		// ret.hilbertValue = ((hilbertValue >= rectangle.hilbertValue) ? hilbertValue :
		// rectangle.hilbertValue);
	...
	public String toString() {
		// if(description == null)
		// return "Rectangle Low:" + low + "\tHigh:" + high + "\tHilbert value: " +
		// hilbertValue + "\n";
	 ...
	 * 2.查询点p在R外，若最短距离距离（p到R的边）存在，则MINDIST=p到R的边的最短距离， 否则，MINDIST=p
	 * R的顶点的最短最短距离。<p>
	 * 
	 ...
	 * 
	 * MINMAXDIST(P,R)：the minimum over all dimensions distance from P to the
	 * furthest point of the closest face of the R
	 * <p>
	 * The important of MINMAXDIST(P,M) is that it computes the smallest distance
	 * between point P
	 * and MBR M that gurantees the finding of an object in M at a Enclidean
	 * distance less than or equal to MINMAXDIST(P,M).
	 * 
	 * @param point
